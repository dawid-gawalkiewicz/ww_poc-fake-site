...
<?php if ( $wp_query->max_num_pages > 1 ) : ?>
	<div id="nav-above" class="navigation">
		<div class="nav-previous"><?php next_posts_link( __( 'Starsze posty<br /><br />', 'twentyten' ) ); ?></div>
		<div class="nav-next"><?php previous_posts_link( __( 'Nowsze posty<br /><br />', 'twentyten' ) ); ?></div>
	</div><!-- #nav-above -->
<?php endif; ?>
...
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
				<div id="nav-below" class="navigation">
					<div class="nav-previous"><?php next_posts_link( __( 'Starsze posty', 'twentyten' ) ); ?></div>
					<div class="nav-next"><?php previous_posts_link( __( 'Nowsze posty', 'twentyten' ) ); ?></div>
				</div><!-- #nav-below -->
<?php endif; ?>
